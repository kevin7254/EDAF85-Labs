...
class ActorThreadTest {
    ...
    void testBidirectional() throws InterruptedException {
        checkMainPrints(actor.test.ExampleBidirectional::main,
    ...
    void testProducerConsumer() throws InterruptedException {
        checkMainPrints(actor.test.ExampleProducerConsumer::main,
    ...
    void testMessagingWithTimeout() throws InterruptedException {
        checkMainPrints(actor.test.ExampleMessagingWithTimeout::main,
                "consumer eagerly awaiting messages...\n" + 
                "received [ole]\n" + 
                "received [dole]\n" + 
                "received [null]\n" + 
    ...
    void testMessagingWithTimeoutButMessagesWaiting() throws InterruptedException {
        checkMainPrints(actor.test.ExampleReceiveWithTimeoutKeepsMessagesInOrder::main,
                "consumer eagerly awaiting messages...\n" + 
                "received [yxi]\n" + 
                "received [kaxi]\n" + 
                "received [kolme]\n" + 
